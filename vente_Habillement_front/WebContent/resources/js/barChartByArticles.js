function renderBarChartByArticles() {
            var labelsSet = [];
            var dataSet = [];
			var str = '<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:bus="http://business.service/"><soapenv:Header/> <soapenv:Body><bus:getVenteCountByArticle/></soapenv:Body></soapenv:Envelope>';
            ...
            xhr.onload = function () {
                ...
                new Chart(document.getElementById("bar-chart-article"), {
                    type: 'doughnut',
                    duration:3000,
                    data: {
                        labels: labelsSet,
